            ...
            {user ? (
              <>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-xl border border-gray-100 py-1 hidden group-hover:block">
                    <Link to="/profile" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      {t('profile')}
                    </Link>
                    {isAdmin && (
                      <Link to="/admin" className="block px-4 py-2 text-sm text-green-700 font-semibold hover:bg-gray-100">
                        {t('admin')}
                      </Link>
                    )}
                    <button
